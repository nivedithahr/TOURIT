...
public class afterbookMurbeshwar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guideName.setText("Rajesh");
        guideEmail.setText("rajesh@gmail.com");
        guideMob.setText("+91 9687543210");
        ...
        returnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(afterbookMurbeshwar.this,MainActivity.class));
            }
        });
