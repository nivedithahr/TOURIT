...
public class coorgbookguide extends AppCompatActivity {

    private EditText regName,regPhone,regPeople,regDays;
    private TextView regDate,regTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(coorgbookguide.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        regTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(coorgbookguide.this, R.style.Theme_AppCompat, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void submitForm() {
        ...
        if (name.isEmpty() || phone.isEmpty() || people.isEmpty() || days.isEmpty() || restaurant.isEmpty() || date.isEmpty()){
            ...
            Intent intent = new Intent(coorgbookguide.this,AfterRegister.class);
    ...
    private static String[] resturant = new String[]{"Palm Era Resorts","Green Vista Homestay","Heritage Resort Coorg","Down's Retreat, A Golf Resort","Maxima Resort","Club Mahindra Madikeri Resort and Spa"};
}