...
public class bookMudeshwar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(bookMudeshwar.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        regTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(bookMudeshwar.this, R.style.Theme_AppCompat, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void submitForm() {
        ...
        if (name.isEmpty() || phone.isEmpty() || people.isEmpty() || days.isEmpty() || restaurant.isEmpty() || date.isEmpty()){
            ...
            Intent intent = new Intent(bookMudeshwar.this,AfterRegisterErawanPark.class);
