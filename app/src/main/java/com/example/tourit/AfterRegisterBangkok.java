...
public class AfterRegisterBangkok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guideName.setText("Amartya");
        guideEmail.setText("amartyad@gmail.com");
        guideMob.setText("+91 9123359755");
        ...
        returnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AfterRegisterBangkok.this,MainActivity.class));
            }
        });
