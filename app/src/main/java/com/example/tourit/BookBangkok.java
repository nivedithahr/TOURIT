...
public class BookBangkok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookBangkok.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        regTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(BookBangkok.this, R.style.Theme_AppCompat, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void submitForm() {
        ...
        if (name.isEmpty() || phone.isEmpty() || people.isEmpty() || days.isEmpty() || restaurant.isEmpty() || date.isEmpty()){
            ...
            Intent intent = new Intent(BookBangkok.this,AfterRegisterBangkok.class);
    ...
    private static String[] resturant = new String[]{"Riva Arun Bangkok(0.7 kilometer to Grand Palace)","Sala rattanakosin(0.6 kilometer to Grand Palace)","Baan Wanglang Riverside(0.7 kilometer to Grand Palace)","Siri Heritage Bangkok Hotel(0.6 kilometer to Grand Palace)"};
}